                ...
                <BodyContainer>
                    ...
                    <MainContainer>
                        ...
                        <CustomTabPanel value={tabsValue} index={2}>
                            <EnterGradesContainer>
                                <BlendEnterGrades examId='11' selectedGrade={selectedOption} studentId={studentId} />
                                <BlendEnterGrades examId='12' selectedGrade={selectedOption} studentId={studentId} />
                                <BlendEnterGrades examId='13' selectedGrade={selectedOption} studentId={studentId} />
                                <BlendEnterGrades examId='14' selectedGrade={selectedOption} studentId={studentId} />
                            </EnterGradesContainer>
                        </CustomTabPanel>
                    </MainContainer>
